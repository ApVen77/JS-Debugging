...
//#4: The next block of code hides three reference errors one syntax errors. Run the code as-is to find the mistakes.
// var numKids  = 5;
...
//#8: The next block of code hides one   logical error. Run the code as-is to find the mistakes.
// a = 5;
// b = 6;
// c = a + b;
// while( a < b) {
...
//#9: The next block of code hides two logical errors. Run the code as-is to find the mistakes.
let text = "";
let i = 0;
do {
  text += i + "<br>";
